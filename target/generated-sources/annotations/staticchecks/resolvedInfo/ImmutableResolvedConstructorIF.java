 ...
 * {@code ImmutableResolvedConstructorIF.builder()}.
 */
@SuppressWarnings({"all"})
@Generated({"Immutables.generator", "ResolvedConstructorIF"})
public final class ImmutableResolvedConstructorIF implements ResolvedConstructorIF {
  private final ImmutableList<ResolvedParam> arguments;
  private final BlockStatement body;
  private final ImmutableSet<Modifier> modifiers;

  private ImmutableResolvedConstructorIF(
   ...
   */
  public final ImmutableResolvedConstructorIF withArguments(ResolvedParam... elements) {
    ImmutableList<ResolvedParam> newValue = ImmutableList.copyOf(elements);
    return new ImmutableResolvedConstructorIF(newValue, this.body, this.modifiers);
  }
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableResolvedConstructorIF withArguments(Iterable<? extends ResolvedParam> elements) {
   ...
   */
  public final ImmutableResolvedConstructorIF withBody(BlockStatement value) {
    if (this.body == value) return this;
    BlockStatement newValue = Objects.requireNonNull(value, "body");
    return new ImmutableResolvedConstructorIF(this.arguments, newValue, this.modifiers);
  }
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableResolvedConstructorIF withModifiers(Modifier... elements) {
    ImmutableSet<Modifier> newValue = ImmutableSet.copyOf(elements);
    return new ImmutableResolvedConstructorIF(this.arguments, this.body, newValue);
  }
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableResolvedConstructorIF withModifiers(Iterable<? extends Modifier> elements) {
  ...
  /**
   * This instance is equal to all instances of {@code ImmutableResolvedConstructorIF} that have equal attribute values.
   * @return {@code true} if {@code this} is equal to {@code another} instance
   */
  @Override
  public boolean equals(Object another) {
    if (this == another) return true;
    return another instanceof ImmutableResolvedConstructorIF
        && equalTo((ImmutableResolvedConstructorIF) another);
  }

  private boolean equalTo(ImmutableResolvedConstructorIF another) {
  ...
  /**
   * Prints the immutable value {@code ResolvedConstructorIF} with attribute values.
   * @return A string representation of the value
   */
  @Override
  public String toString() {
    return MoreObjects.toStringHelper("ResolvedConstructorIF")
        .omitNullValues()
   ...
   * @return A copied immutable ResolvedConstructorIF instance
   */
  public static ImmutableResolvedConstructorIF copyOf(ResolvedConstructorIF instance) {
    if (instance instanceof ImmutableResolvedConstructorIF) {
      return (ImmutableResolvedConstructorIF) instance;
    }
    return ImmutableResolvedConstructorIF.builder()
        .from(instance)
        .build();
  }

  /**
   * Creates a builder for {@link ImmutableResolvedConstructorIF ImmutableResolvedConstructorIF}.
   * @return A new ImmutableResolvedConstructorIF builder
   */
  public static ImmutableResolvedConstructorIF.Builder builder() {
    return new ImmutableResolvedConstructorIF.Builder();
  }

  /**
   * Builds instances of type {@link ImmutableResolvedConstructorIF ImmutableResolvedConstructorIF}.
  ...
  public static final class Builder {
    ...
    /**
     * Builds a new {@link ImmutableResolvedConstructorIF ImmutableResolvedConstructorIF}.
     * @return An immutable instance of ResolvedConstructorIF
     * @throws java.lang.IllegalStateException if any required attributes are missing
     */
    public ImmutableResolvedConstructorIF build() {
      if (initBits != 0) {
        throw new IllegalStateException(formatRequiredAttributesMessage());
      }
      return new ImmutableResolvedConstructorIF(arguments.build(), body, modifiers.build());
    }

    private String formatRequiredAttributesMessage() {
      List<String> attributes = Lists.newArrayList();
      if ((initBits & INIT_BIT_BODY) != 0) attributes.add("body");
      return "Cannot build ResolvedConstructorIF, some of required attributes are not set " + attributes;
    }
  }
}
